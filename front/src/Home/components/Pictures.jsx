    ...
    <div id='תמונות' className='w-full'>
      ...
      >
        ...
        <motion.div initial="hidden" whileInView="visible" variants={zoomInVariants} 
          className='w-full grid lg:grid-cols-4 grid-cols-1 gap-[20px]'
        >
          <img src={project1} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project2} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project3} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project4} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project5} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project6} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project7} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
          <img src={project8} alt='project image' className='h-[250px] w-full object-cover rounded-lg' />
        </motion.div>
        <motion.button
