...
import { deleteDonor, getPendingDonors, updateDonor } from '../../commons/Restapi/DonorRestapi';
    ...
    function rowContent(_index: number, row: Donor) {
      ...
      return (
        <>
          ...
          <TableCell align="right" sx={{ fontSize: { xs: '9px', sm: '10px', md: '12px' } }}>{row.street}, {row.address}</TableCell>
